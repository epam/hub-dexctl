...
func init() {
	...
	createOidcCmd.Flags().StringVarP(&clientId, "clientId", "c", "", "Client ID used to identify the client")
	createOidcCmd.MarkFlagRequired("clientId")
	createOidcCmd.Flags().StringVarP(&clientSecret, "clientSecret", "s", "", "Client secret used to identify the client")
	createOidcCmd.MarkFlagRequired("clientSecret")
	createOidcCmd.Flags().StringArrayVarP(&redirectUris, "redirectUris", "r", nil, "A registered set of redirect URIs")
	createOidcCmd.MarkFlagRequired("redirectUris")
	createOidcCmd.Flags().StringArrayVarP(&trustedPeers, "trustedPeers", "t", nil, "TrustedPeers are a list of peers which can issue tokens on this client's behalf using the dynamic scope")
	...
	createOidcCmd.Flags().StringVarP(&logoUrl, "logoUrl", "l", "", "LogoURL used when displaying this client to the end user")
	createOidcCmd.MarkFlagsRequiredTogether("clientId", "clientSecret", "redirectUris", "name")
